                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return ListTile(
                        leading: Image.network(
                          state.searchResult![index].profile.avatar,
                        ),
                        title: Text(
                          '${state.searchResult![index].profile.firstName} ${state.searchResult![index].profile.lastName}',
                        ),
                        subtitle:
                            Text(state.searchResult![index].profile.email),
                      );
                    },
                  ),
          );
