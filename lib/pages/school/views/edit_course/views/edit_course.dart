...
class InstEditCourse extends StatefulWidget {
  const InstEditCourse({super.key});

  @override
  State<InstEditCourse> createState() => _InstAddNewCourseState();
}

class _InstAddNewCourseState extends State<InstEditCourse> {
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border:
                          Border.all(color: KorbilTheme.of(context).alternate1),
                    ),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
